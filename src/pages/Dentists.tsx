...
import { Phone, Mail, Search, ArrowLeft } from "lucide-react";
...
const dentists: Dentist[] = [
  { id: 1, name: "Dra. Fernanda Costa", specialty: "Ortodontia", status: "Ativo", totalSlots: 10, openSlots: 3, phone: "(41) 97777-6666", email: "fernanda@dentist.com", crm: "CRO-PR 12345", schedule: [{ day: "Segunda", time: "08:00-12:00" }, { day: "Quarta", time: "14:00-18:00" }, { day: "Sexta", time: "08:00-12:00" }], tickets: [{ id: "TKT-001", patient: "Maria Oliveira", subject: "Tratamento ortodôntico", date: "05/04/2025", status: "Aberto" }, { id: "TKT-027", patient: "João Santos", subject: "Consulta", date: "15/01/2025", status: "Resolvido" }] },
  { id: 2, name: "Dr. Ricardo Souza", specialty: "Endodontia", status: "Ativo", totalSlots: 8, openSlots: 0, phone: "(11) 96666-5555", email: "ricardo@dentist.com", crm: "CRO-SP 67890", schedule: [{ day: "Terça", time: "09:00-13:00" }, { day: "Quinta", time: "09:00-13:00" }], tickets: [{ id: "TKT-062", patient: "Ana Luiza", subject: "Canal dentário", date: "18/02/2025", status: "Fechado" }] },
  { id: 3, name: "Dra. Julia Mendes", specialty: "Odontopediatria", status: "Inativo", totalSlots: 6, openSlots: 6, phone: "(21) 95555-4444", email: "julia@dentist.com", crm: "CRO-RJ 11111", schedule: [], tickets: [] },
  { id: 4, name: "Dr. Marcos Lima", specialty: "Implantodontia", status: "Ativo", totalSlots: 12, openSlots: 5, phone: "(31) 94444-3333", email: "marcos@dentist.com", crm: "CRO-MG 22222", schedule: [{ day: "Segunda", time: "14:00-18:00" }, { day: "Quarta", time: "08:00-12:00" }, { day: "Sexta", time: "14:00-18:00" }], tickets: [{ id: "TKT-055", patient: "João Santos", subject: "Implante", date: "10/02/2025", status: "Resolvido" }] },
  { id: 5, name: "Dra. Ana Ribeiro", specialty: "Periodontia", status: "Ativo", totalSlots: 8, openSlots: 2, phone: "(85) 93333-2222", email: "ana.r@dentist.com", crm: "CRO-CE 33333", schedule: [{ day: "Terça", time: "14:00-18:00" }, { day: "Quinta", time: "14:00-18:00" }], tickets: [{ id: "TKT-048", patient: "Lucia Ferreira", subject: "Tratamento gengival", date: "03/02/2025", status: "Fechado" }] },
];
              ...
              <TableRow key={d.id} className="cursor-pointer hover:bg-accent/50 transition-colors" onClick={() => setSelected(d)}>
                ...
                <TableCell>
                  <div className="flex gap-2" onClick={(e) => e.stopPropagation()}>
                    <button className="text-muted-foreground hover:text-foreground"><Phone className="w-4 h-4" /></button>
                    <button className="text-muted-foreground hover:text-foreground"><Mail className="w-4 h-4" /></button>
                  </div>
                </TableCell>
              </TableRow>
            ))}
